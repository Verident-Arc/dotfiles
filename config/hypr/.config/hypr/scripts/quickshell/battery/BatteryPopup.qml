    ...
    Item {
        ...
        Rectangle {
            ...
            Row {
                ...
                // Hours Box
                Rectangle {
                    width: 44; height: 48; radius: 14
                    color: "#0dffffff"; border.color: "#1affffff"; border.width: 1
                    
                    Rectangle { anchors.fill: parent; radius: 14; color: window.ambientPrimary; opacity: 0.05; Behavior on color { ColorAnimation { duration: 1000 } } }
                    Column {
                        anchors.centerIn: parent
                        Text { 
                ...
                Rectangle {
                    ...
                    Rectangle { anchors.fill: parent; radius: 14; color: window.ambientSecondary; opacity: 0.05; Behavior on color { ColorAnimation { duration: 1000 } } }
                    Column {
                        anchors.centerIn: parent
                        Text { 
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Repeater {
                        model: ListModel {
                            ListElement { cmd: "bash /home/_null/.config/hypr/scripts/toggle_awake.sh"; icon: "󰅶"; baseColor: "green"; weight: 1.0 }
                            ListElement { cmd: "bash /home/_null/.config/hypr/scripts/lock.sh"; icon: ""; baseColor: "mauve"; weight: 1.0 }
                            ListElement { cmd: "bash /home/_null/.config/hypr/scripts/lock.sh & systemctl suspend"; icon: "ᶻ 𝗓 𐰁"; baseColor: "blue"; weight: 1.0 }
