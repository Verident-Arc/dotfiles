            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        Text {
                            id: filterText
                            visible: modelData.hex === "" && modelData.name !== "Video" && modelData.name !== "All" && modelData.name !== "Custom"
                        ...
                        Canvas {
                            ...
                            width: 14; height: 14
                            anchors.centerIn: parent
                            property string activeColor: Qt.rgba(_theme.text.r, _theme.text.g, _theme.text.b, 0.7)
                            ...
                            onPaint: {
                                ...
                                ctx.beginPath();
                                ctx.moveTo(7, 0); ctx.lineTo(7, 14);
                                ctx.moveTo(0, 7); ctx.lineTo(14, 7);
                                ctx.stroke();
                            }
                        }
                    ...
                    MouseArea {
                        ...
                        hoverEnabled: true 
                        onClicked: {
                            if (modelData.name === "Custom") {
                                const addScriptPath = Qt.resolvedUrl("add_custom_wallpaper.sh").toString().replace("file://", "");
                                Quickshell.execDetached(["bash", addScriptPath]);
                            } else {
