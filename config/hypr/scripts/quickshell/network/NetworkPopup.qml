                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                if (window.activeMode !== "wifi") {
                                    Quickshell.execDetached(["bash", "-c", "pkill -f \"bluetoothctl scan on\" 2>/dev/null || true; rm -f " + Quickshell.env("HOME") + "/.cache/bt_scan_pid"]);
                                    window.playSfx("switch.wav");
                                }
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                if (window.activeMode !== "bt") {
                                    // Stop the current Wi-Fi scanning process if active
                                    Quickshell.execDetached(["bash", "-c", "nmcli device wifi rescan > /dev/null 2>&1 & exit"]);
                                    window.playSfx("switch.wav");
                                }
